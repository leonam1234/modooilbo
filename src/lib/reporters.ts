/**
 * 모두일보 기자 로스터 — 기자 프로필 페이지(/reporter/[slug])의 정본.
...
export const REPORTERS: Reporter[] = [
  ...
  {
    slug: "park-yuju",
    photo: "/reporters/park-yuju.jpg",
    name: "박유주",
    role: "논설위원",
    beat: "모두일보의 시각을 칼럼과 사설로 전합니다. 산업·기술 분야를 취재해 왔습니다.",
    expertise: "산업 정책·기업 동향, 정부 R&D·기술 지원사업 분석",
    // 2026-09-07 신규 집필을 종료했다. 기존 기사의 바이라인과 프로필은 보존한다.
    listed: false,
  },
  // 2026-09-07 합류. 확인된 역할과 담당 축만 기재하며, 사진·외부 경력·개인 메일은
  // 본인 확인 전 추가하지 않는다. 사진이 없을 때는 프로필 페이지가 이니셜 아바타를 쓴다.
  {
    slug: "ryu-juhyeong",
    name: "류주형",
    role: "취재기자",
    beat: "오피니언과 산업 분야를 취재합니다.",
    expertise: "오피니언·산업 분야 취재",
  },
