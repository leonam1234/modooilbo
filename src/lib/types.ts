...
export interface Article {
   ...
   * 공개 명단 페이지(/partners)는 2026-09-25 폐지 — 광고주 등록은 sponsors.ts 한 곳이다(계약서 서명 후).
   *
  ...
  /** 실제 검수한 등록 기자 이름 또는 승인된 역할명 모두일보 독립 리뷰 담당. 임의 명칭은 금지. */
  reviewedBy?: string;
  /** 실제 최종 검수 완료 KST 시각. publishedAt보다 늦을 수 없다. */
  reviewedAt?: string;
