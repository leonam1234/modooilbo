...
export function TrendingTags() {
  ...
  return (
    <div className="relative border-b border-ink-100 bg-white/95 backdrop-blur-2xl backdrop-saturate-150 supports-[backdrop-filter]:bg-white/50 dark:border-ink-800 dark:bg-ink-950/95 dark:supports-[backdrop-filter]:bg-ink-950/60">
      ...
      {open && (
        <div
          ref={panelRef}
          className="absolute inset-x-0 top-full z-50 border-b border-ink-100 bg-white/95 shadow-lg backdrop-blur-2xl dark:border-ink-800 dark:bg-ink-950/95 sm:hidden"
        >
