...
export const metadata: Metadata = {
  title: "윤리강령",
  description:
    "모두일보의 편집강령, 취재·보도 윤리, 정정·반론 보도 원칙, 댓글·커뮤니티 정책과 청소년보호정책을 안내합니다. 취재·보도 윤리와 정정·반론 원칙, 댓글·커뮤니티 정책, 청소년보호정책과 고충처리인 제도를 조문으로 담았습니다. 모든 기자와 기고자에게 적용됩니다.",
                ...
                <dl className="space-y-2.5 text-sm">
                  ...
                  <div className="flex gap-3">
                    ...
                    <dd className="text-ink-700 dark:text-ink-200">
                      <PlainEmailLink
                        address={PUBLIC_EMAILS.ombudsman}
                        className="font-medium text-signal-600 hover:text-signal-700 dark:text-signal-400"
                      />
                    </dd>
                  </div>
