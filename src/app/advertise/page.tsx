...
export const metadata: Metadata = {
  title: "광고·제휴",
  description:
    "월 순방문자 1,200만, 페이지뷰 4,800만의 신뢰받는 매체 모두일보와 함께하세요. 디스플레이·네이티브·뉴스레터·브랜디드 콘텐츠 광고 및 콘텐츠·API 제휴 안내. 배너 광고와 브랜디드 콘텐츠, 후원 방식과 집행 절차를 안내합니다. 광고성 콘텐츠는 기사와 구분해 광고 표기와 함께 발행하며 편집권은 독립적으로 행사합니다.",
