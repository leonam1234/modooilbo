...
const TIMELINE: { year: string; event: string }[] = [
  ...
  {
    year: "2026",
    event: "데이터저널리즘팀 출범. 첫 인터랙티브 탐사보도 ‘도시의 침묵’ 공개.",
  },
  {
    year: "2027",
  ...
  {
    year: "2028",
    event: "팩트체크 센터 신설. 한국온라인신문협회 정회원 가입.",
  },
  {
    year: "2029",
    event: "글로벌 에디션 영문 서비스 개시. 국제탐사보도언론인협회(ICIJ) 공동 프로젝트 참여.",
  },
  {
    year: "2030",
    event: "이달의 기자상 등 주요 언론상 수상. 누적 구독자 50만 돌파.",
  },
];
