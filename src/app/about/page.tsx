...
export const metadata: Metadata = {
  title: "회사소개",
  description:
    "모두일보는 모두를 위한 신뢰의 뉴스를 전하는 독립 디지털 언론입니다. 미션과 핵심 가치, 연혁, 편집 원칙을 소개합니다. 등록번호 경기 아54891로 등록한 인터넷신문이며, 나라장터·기업마당·DART 등 공공 원자료를 직접 확인해 기사를 씁니다. 편집국 구성과 윤리강령도 함께 공개합니다.",
...
const VALUES: { title: string; body: string }[] = [
  {
    title: "정확성",
    body: "단독보다 사실이 먼저입니다. 보도는 나라장터·기업마당·DART 등 공식 원자료를 직접 확인해 작성하며, 오류가 확인되면 즉시 바로잡고 그 과정을 투명하게 공개합니다.",
  },
  {
    title: "독립성",
...
const ORG: { name: string; desc: string }[] = [
  {
    name: "편집국",
    desc: "경제·사회·국제·문화 등 전 분야 취재와 데스킹을 담당하는 보도의 중심입니다.",
  },
  {
    name: "데이터저널리즘팀",
  ...
  {
    name: "팩트체크 센터(준비 중)",
    desc: "공적 발언과 온라인 정보의 사실 여부를 독립적으로 검증하는 조직으로, 단계적으로 준비하고 있습니다.",
  },
  {
    name: "독자서비스국",
      ...
      <section className="container-page py-12">
        <div className="grid gap-10 lg:grid-cols-[1fr_1.4fr] lg:gap-16">
          ...
          <div className="space-y-5 text-lg leading-relaxed text-ink-600 dark:text-ink-300">
            ...
            {/* 기업 데이터 정체성 — 2026-07-13 방향 전환 회의 결론을 미션에 반영(2026-08-21).
                홈 메타 설명과 발행 구성은 이미 이 정체성인데 이 페이지만 종합뉴스 시절
                일반론에 머물러 있었다. */}
            <p>
              특히 우리는 <b className="font-semibold text-ink-800 dark:text-ink-100">기업에 필요한
              공공데이터</b>를 매일 들여다봅니다. 나라장터 입찰공고, 정부지원사업, 기업마당,
              DART 공시 같은 공식 원자료를 직접 열어 확인하고, 금액과 마감 시각, 자격요건,
              필요서류를 기사 안에 그대로 밝힙니다. 중소기업 대표와 소상공인, 스타트업,
              인사·총무·재무·구매 실무 담당자가 오늘 무엇을 해야 하는지 알 수 있게 하는 것이
              목표입니다.
            </p>
            <p>
              해당되지 않는 기업과 오해하기 쉬운 조건도 함께 적습니다. 공고를 그대로 옮기는
              대신 누가 대상이고 누가 아닌지를 가려내는 일이, 종합뉴스에서 사실을 확인하는
              일과 다르지 않다고 보기 때문입니다.
            </p>
            <p>
