...
// 정부지원금 — 기업 데이터 뉴스 '사업' 축의 정식 카테고리 목록 페이지.
// (기사가 붙어 승격됨 → noindex 해제. bids 등 준비 중 메뉴는 BizComingSoon·noindex 유지.)
const cat = getCategory("grants")!;
...
export const metadata: Metadata = {
  ...
  openGraph: { title, description, type: "website", url: "/grants/", images: [DEFAULT_OG_IMAGE] },
  twitter: { card: "summary_large_image", title, description, images: [DEFAULT_OG_IMAGE.url] },
};

export default function GrantsPage() {
  const articles = getByCategory("grants");
