...
export const metadata: Metadata = {
  title: "제보하기",
  description:
    "당신의 제보가 세상을 바꿉니다. 모두일보는 제보자의 신원을 철저히 보호하며, 모든 제보를 신중하게 검증해 보도로 이어갑니다. 제보자의 신원은 보호하며 원하지 않으면 취재에 사용하지 않습니다. 접수하시면 서버가 발급한 접수번호를 드리고 담당 기자가 사실관계를 확인한 뒤 회신합니다.",
