...
export const metadata: Metadata = {
  title: "고충처리인 제도",
  description:
    "모두일보 고충처리인의 역할과 접수 방법, 처리 절차를 안내합니다. 보도로 인한 피해나 불만을 접수해 처리합니다. 보도로 권익이 침해됐다고 판단하실 때 접수 방법과 처리 절차, 회신 기한을 안내합니다. 고충처리인은 취재 기록과 원출처를 다시 확인해 필요하면 편집국에 시정을 권고합니다.",
