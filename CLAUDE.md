...
- 2026-09-16 정정: AI 독립 검수의 `reviewedBy`는 정확히 `모두일보 독립 리뷰 담당`이며 실제 완료 시각과 기사별 고유 해설을 기록한다. 사람의 실명을 대신 기입하지 않는다. 아래 ‘사람 검수 필드’는 실제 독립 검수 기록으로 해석한다. 일일 자동 제작 최소 범위는 상단 6개 카테고리 각 2편이며, 오너 별도 제공 직접취재의 미도착 수량·비율로 상단 READY 기사를 차단하지 않는다.
