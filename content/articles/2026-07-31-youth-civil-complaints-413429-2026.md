...
두 수치를 하나로 확정할 추가 설명이나 정정 공지는 7월 31일 07:25:10까지 공식 게시물에서 확인되지 않았다. 이 때문에 성별 비중은 기사의 핵심 수치와 해석에서 제외했다. 연령별 건수와 비율, 분석 기간, 대상 연령, 다섯 민원 분야는 보도자료와 별첨 보고서에서 일치했다.
